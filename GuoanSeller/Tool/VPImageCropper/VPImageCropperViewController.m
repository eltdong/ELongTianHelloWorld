...
- (void)initView {
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH-100, SCREENHEIGHT-100)];
    ...
    self.showImgView.backgroundColor = [UIColor blueColor];
...
- (void)initControlBtn {
    UIView * bjView = [[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50)];
