...
@synthesize panGestureRecognizerEnable = panGestureRecognizer;
#pragma mark - setup
...
//            NSCAssert([sourceCollectionViewCell isKindOfClass:[LxGridViewCell class]] || sourceCollectionViewCell == nil, @"1LxGridViewFlowLayout: Must use LxGridViewCell as your collectionViewCell class!");
            if (![sourceCollectionViewCell isKindOfClass:[LxGridViewCell class]]) {
                return;
            }
            LxGridViewCell * sourceGridViewCell = (LxGridViewCell *)sourceCollectionViewCell;
#pragma mark - 去除移动时有的偏移量
...
#pragma mark - 抖动效果去除 yd
//            [_beingMovedPromptView.layer addAnimation:vibrateAnimation forKey:kVibrateAnimation];// yd
...
- (void)panGestureRecognizerTriggerd:(UIPanGestureRecognizer *)pan
{
    ...
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            UICollectionViewCell * sourceCollectionViewCell = [self.collectionView cellForItemAtIndexPath:destinationIndexPath];
            
            if ((destinationIndexPath == nil) || [destinationIndexPath isEqual:sourceIndexPath]|| ![sourceCollectionViewCell isKindOfClass:[LxGridViewCell class]]) {
                return;
            }
