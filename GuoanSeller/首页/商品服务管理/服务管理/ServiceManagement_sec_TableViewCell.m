...
@implementation ServiceManagement_sec_TableViewCell

- (void)awakeFromNib {
    // Initialization code
////    self.content_name.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
////    self.content_name.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
//    self.content_name.
...
-(void)setClModel:(CommodityListModel *)clModel{
    _clModel  = clModel;
//    [self.content_img setImageWithURL:[NSURL URLWithString:clModel.content_img] placeholderImage:[UIImage imageNamed:@"propic"]];//占位图
